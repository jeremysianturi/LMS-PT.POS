...
import com.pos.lms.mobile.databinding.MCPFragmentBinding
...
class MCPFragment : Fragment() {
    ...
    private lateinit var adapterPromosi: MCPPromosiAdapter
    private lateinit var adapterRotasi: MCPRotasiAdapter

    private var dataBundle: EventRoadmap? = null
    private lateinit var mPreference: UserPreference
    private lateinit var mPreferenceEntity: PreferenceEntity

    private var _binding: MCPFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = MCPFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupObserver(dataBundle: EventRoadmap?) {
        ...
        viewModel.mcpRotasi(eventCode.toString(), personalNumber.toString(), begda, enda)
        ...
        viewModel.mcpPromosi(eventCode.toString(), personalNumber.toString(), begda, enda)
            .observe(requireActivity(), { data ->
                if (data != null) {
                    when (data) {
                        is Resource.Loading -> binding.progressBarProposal.visibility = View.VISIBLE
