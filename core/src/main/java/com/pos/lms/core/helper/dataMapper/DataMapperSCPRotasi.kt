...
import com.pos.lms.core.data.source.local.entity.roadmap.SCPRotasiEntity
...
object DataMapperSCPRotasi {
    ...
    fun mapEntitiesToDomain(input: List<SCPRotasiEntity>): List<SCPRotasi> =
        input.map {
            SCPRotasi(
